...
class WebSimulationEngine extends SimulationEngine {
  ...
  Widget createSimulation(BuildContext context) {
    return _WebSimulationView(controller: context.read<SimulationController>());
  }
}

class _WebSimulationView extends StatefulWidget {
  final SimulationController controller;

  const _WebSimulationView({required this.controller});

  @override
  State<_WebSimulationView> createState() => _WebSimulationViewState();
}

class _WebSimulationViewState extends State<_WebSimulationView> {
